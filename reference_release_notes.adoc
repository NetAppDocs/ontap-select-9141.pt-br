...
Pode aceder ao https://library.netapp.com/ecm/ecm_download_file/ECMLP2886733["Notas de versão do ONTAP Select 9.14.1"^] para visualizar os detalhes sobre a versão atual.
